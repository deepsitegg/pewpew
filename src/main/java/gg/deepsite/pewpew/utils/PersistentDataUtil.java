...
public class PersistentDataUtil {
    ...
    @NotNull
    public static ItemStack setPewpew(ItemStack itemStack, String value, String key) {
        ItemMeta itemMeta = itemStack.getItemMeta();
        if (itemMeta == null) return itemStack;
        itemMeta.getPersistentDataContainer().set(createPewpewKey(key), PersistentDataType.STRING, value);
        itemStack.setItemMeta(itemMeta);
        return itemStack;
    }

    @Nullable
    public static String getPewpew(ItemStack itemStack, String key) {
        ItemMeta itemMeta = itemStack.getItemMeta();
        if (itemMeta == null) return null;
        PersistentDataContainer data = itemMeta.getPersistentDataContainer();
        return getData(data, createPewpewKey(key), PersistentDataType.STRING);
    }

    public static boolean containsPewpew(ItemStack itemStack, String key) {
        ItemMeta itemMeta = itemStack.getItemMeta();
        if (itemMeta == null) return false;
        return itemMeta.getPersistentDataContainer().has(createPewpewKey(key));
    }

    @NotNull
    private static NamespacedKey createPewpewKey(String key) {
        return new NamespacedKey("pewpew", key);
    }
