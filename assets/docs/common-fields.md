...
These fields apply to every item type (`GUN`, `AMMO`, `MAGAZINE`, `ATTACHMENT`, `THROWABLE`).

| Field             | Type         | Default | Required | Description                                                                                                                             |
|-------------------|--------------|---------|----------|-----------------------------------------------------------------------------------------------------------------------------------------|
| `type`            | enum         | -       | yes      | One of `GUN`, `AMMO`, `MAGAZINE`, `ATTACHMENT`, `THROWABLE`. Selects how the rest of the entry is read.                                 |
